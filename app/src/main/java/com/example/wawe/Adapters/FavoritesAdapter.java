...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ViewHolder> {
    ...
    public static List<Restaurant> favoritesRestaurants;
    Context context;
    YelpRestaurant yelpRestaurant;
    String id;

    public FavoritesAdapter(Context context, List<Restaurant> visitedRestaurants) {
        this.context = context;
        favoritesRestaurants = visitedRestaurants;
    }
    ...
    public void onBindViewHolder(@NonNull FavoritesAdapter.ViewHolder holder, int position) {
        Restaurant restaurant = favoritesRestaurants.get(position);
        holder.bind(restaurant);
    }

    @Override
    public int getItemCount() {
        return favoritesRestaurants.size();
    }
        ...
        public void onClick(View view) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                ...
                if (MainActivity.isOnline(context)) {
                    ...
                    new FavoritesAdapter.Task().execute();
                } else {
